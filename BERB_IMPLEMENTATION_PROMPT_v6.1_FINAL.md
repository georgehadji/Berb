...
**Date:** 2026-03-29
**Version:** 6.1.0 Enhancement Specification (scite.ai + Claude Scholar + ThesisAI + Auto-Research + Jenni AI + Writeless AI)
...
## ENHANCEMENT GROUP A: DUAL OPERATION MODE (P0)

### A1. Autonomous + Collaborative Mode System

**File:** `berb/modes/operation_mode.py`

The system must support two fundamental operation modes:
...
**API (when API layer exists):**
```
POST /research --body { "mode": "collaborative", "pause_after": [2,6,8,15,18] }
GET  /research/{id}/pending-approval
POST /research/{id}/approve --body { "feedback": "...", "action": "approve" }
```
