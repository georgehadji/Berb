...
- **文件**: `berb/templates/converter.py`
...
- **文件**: `berb/templates/converter.py` + `berb/prompts.py`
...
- **文件**: `berb/experiment/visualize.py`
...
- **修复**: `git checkout main -- berb/agents/figure_agent/ berb/agents/__init__.py berb/agents/base.py tests/test_figure_agent.py`
- **状态**: ✅ 已修复

### T3.3 负面结果处理
- **问题**: 当方法表现不如 baseline 时，论文仍写成 positive contribution
- **文件**: `berb/pipeline/executor.py` + `berb/prompts.py`
